...
if(isset($_POST['pseudo']) AND isset($_POST['message']) AND !empty(['pseudo']) AND !empty(['message']))
{
	...
	$insertmsg = $bdd->prepare('INSERT INTO professeur(pseudo, message) VALUES(?, ?)');
...
<br>
  ...
  cursor: pointer;">
	...
	<br>
	<?php
	$allmsg = $bdd->query('SELECT * FROM eleve');
	while ($msg = $allmsg->fetch())
	{
	?>
	<b><?php echo $msg['pseudo'] ?> à dis <br></b> <p><?php echo $msg['message'] ?></p><br>
	<?php
}
	?>
</center>
